...
namespace WebApplicationShopOnline.Repositories
{
    public class ProductMemoryRepository : IProductDBsRepository
    {
        ...
        public ProductMemoryRepository()
        {
            ...
            {
                _products.AddRange(new List<ProductDB>
                {
                    new ProductDB
                    {
                        Id = Guid.NewGuid(),
                    ...
                    new ProductDB
                    {
                        ...
                        Cost = 250,
                        PathPicture = "https://images.pexels.com/photos/1639557/hamburger-mushroom-beef-burger-1639557.jpg?auto=compress&cs=tinysrgb&w=600"
                    },
                    new ProductDB
                    {
                        Id = Guid.NewGuid(),
